...
<mark>Therefore, the treatment effects should be present at first in the annual reports for the fiscal year 2005 and the treatment happens in fiscal year 2004.</mark>
:::
...
```{r s3b-subsample-diff, echo=TRUE, results='hold'}
...
```{r s3c-subsample-diff, echo=TRUE, results='hold'}
# Calculate the Wald statistics 
