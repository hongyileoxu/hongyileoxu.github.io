...
-   The better research question: what are the determinants of borrower initiated renegotiations?
    ...
    -   Q: very important, <span style="color:red;">why does the borrower need to renegotiate their current debts?</span>
          -   A key answer is that the previous debt contract may contain certain restrictions on the (i) firm's leverage and (ii) ability to access capital market in the future. An increase in either the value of current patent portfolio or the amount of pledgable patents in the firm's patent portfolio should be seen as a positive signal and encourgaes the creditor to take more risk in this lending relationship. 
