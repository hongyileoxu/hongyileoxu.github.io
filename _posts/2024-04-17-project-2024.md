...
- Potential exogenous shock in mind: the underlying idea is that under some exogneous, state or county level shocks,
  ...
  1. the intensification of local competition in the lending market $\rightarrow$ ? ; 
  2. the introduction of new airline, railroad, high speed railway $\rightarrow$ faciliate the information transimission and cost of renegotiation;
